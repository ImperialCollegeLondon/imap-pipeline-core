"""Program to retrieve small forces files from SDC."""
...
def fetch_small_forces(
    start_date: datetime | None = None,
    end_date: datetime | None = None,
    use_database: bool = False,
):
    """Download small forces files from the SDC.
    ...
    logger.info(
        f"Small forces download complete. {len(result.data_items)} files processed."
    )
