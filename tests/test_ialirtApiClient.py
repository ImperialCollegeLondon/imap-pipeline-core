...
def test_download_ialirt_data_in_chunks(
    ...
    response_chunk3: list[dict] = [
        {
            ...
            "mag_theta_B_GSM": 6.732,
            "time_utc": "2025-10-14T03:02:00",
        },
    ]

    wiremock_manager.add_string_mapping(
        "/space-weather?instrument=mag&time_utc_start=2025-10-14T03%3A00%3A00&time_utc_end=2025-10-14T03%3A03%3A00",
        json.dumps(
            {"meta": {"count": 1, "instrument": "mag"}, "data": response_chunk1}
        ),
    )
    wiremock_manager.add_string_mapping(
        "/space-weather?instrument=mag&time_utc_start=2025-10-14T03%3A00%3A11&time_utc_end=2025-10-14T03%3A03%3A00",
        json.dumps(
            {"meta": {"count": 1, "instrument": "mag"}, "data": response_chunk2}
        ),
    )
    wiremock_manager.add_string_mapping(
        "/space-weather?instrument=mag&time_utc_start=2025-10-14T03%3A01%3A01&time_utc_end=2025-10-14T03%3A03%3A00",
        json.dumps(
            {"meta": {"count": 1, "instrument": "mag"}, "data": response_chunk3}
        ),
    )
    wiremock_manager.add_string_mapping(
        "/space-weather?instrument=mag&time_utc_start=2025-10-14T03%3A02%3A01&time_utc_end=2025-10-14T03%3A03%3A00",
        json.dumps({"meta": {"count": 0, "instrument": "mag"}, "data": []}),
    )
    ...
    assert downloaded_data[0]["time_utc"] == "2025-10-14T03:00:10"
    assert downloaded_data[1]["time_utc"] == "2025-10-14T03:01:00"
    assert downloaded_data[2]["time_utc"] == "2025-10-14T03:02:00"
