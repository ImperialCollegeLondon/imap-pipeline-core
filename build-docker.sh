...
# replace "python" with the version number, e.g. "python3.14" -> "3.14"
PYTHON_VERSION_NUMBER="${TOOL_PYTHON_VERSION/python/}"
...
docker build --build-arg PYTHON_VERSION=$PYTHON_VERSION_NUMBER -f deploy/Dockerfile -t $IMAGE_NAME .
